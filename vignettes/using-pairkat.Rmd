...
PaIRKAT is model framework for assessing statistical relationships between 
networks of metabolites (pathways) and an outcome of interest (phenotype). 
...
Glycerophospholipid metabolism has a significant relationship with 
log_FEV1_FVC_ratio when controlling for age (p = 3.9e-05). 
Similarly, Lysine degradation	has a significant relationship with 
log_FEV1_FVC_ratio when controlling for age (p = 1.0e-04). etc.
